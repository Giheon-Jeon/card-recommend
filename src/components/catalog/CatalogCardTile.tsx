...
export function CatalogCardTile({ entry, onSelect, inMyCards, onToggleMyCards }: CatalogCardTileProps) {
  ...
  return (
    <div
      ...
      className="group relative flex flex-col overflow-hidden rounded-2xl border border-slate-200/80 bg-white text-left shadow-sm transition-all duration-200 hover:-translate-y-1 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-100"
    >
      <button
        type="button"
